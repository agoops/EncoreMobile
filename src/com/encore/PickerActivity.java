...
public class PickerActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(FRIEND_PICKER.equals(intentUri)) {
            ...
            // Set the listener to handle the button clicks
    ...
    private void finishActivity() {
        EncoreApplication app = (EncoreApplication) getApplication();
        if(FRIEND_PICKER.equals(getIntent().getData())) {
            if(friendPickerFragment != null) {
                app.setSelectedUsers(friendPickerFragment.getSelection());
                Log.d("-=-=-=-=-=Selected Users: ", friendPickerFragment.getSelection().toString());
            }
        }
